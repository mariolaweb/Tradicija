...
return [
    ...
    */
    ...
    'privacy-paragraf-3' => 'Svakoj takvoj trećoj strani zabranjena je daljnja obrada Vaših ličnih podataka. Svi zaposleni i poslovni partneri odgovorni su za poštovanje načela zaštite privatnosti i u skladu s tim smatraju ih poslovnom tajnom.',
    'privacy-title-2' => 'Informacije o korisnicima koje se automatski prikupljaju na našj web stranici',
    'privacy-paragraf-4' => 'Za razliku od informacija o ličnim podacima koje nam korisnici sami dopuštaju svojim pristankom da sakupljamo, postoje i podaci koji se automaski prikupljaju. Automatski prikupljamo informacije u log datotekama servera, kao što je na primjer vaša IP adresa, vrsta web browsera koji koristite, stranice za preusmjeravanje/izlazak i operativni sistem koji korisnik koristi na svojim uređajima. Koristimo ove informacije kako bismo kvalitetnije upravljali našim web stranicama i našim tehničkim rješenjima, bolje razumjeli kako se posjetioci kreću kroz našu web platformu, te da poboljšamo Vaše iskustvo dok koristite platformu i usluge na njoj.',
    'privacy-title-3' => 'Linkovi prema drugim web stranicama i uslugama treće strane povezanih sa našom djelatnošću',
    'privacy-paragraf-5' => 'Na našoj web stranici ćete biti u prilici da pronađete link koji će vas odvesti na neku drugu web stranicu, platformu ili društvenu mrežu. Te stranice su uglavnom povezane sa našim poslovanjem, sa načinom plaćanja ili dostave proizvoda, sa brendovima i proizvođačima artikala koje prodajemo ili zastupamo i slično. Moguće je da linkovi vode na razna uputstva za korišćenje nekih artikala ili jednostavno za neka detaljnija objašnjenja o samom proizvodu koji želite da naručite, rezervišete ili kupite putem naše web stranice.',
    'privacy-paragraf-6' => 'Linkove postavljamo uglavnom kao pomoć korisnicima za pronalazak detaljnijih informacija, ali morate imati na umu da mi nismo odgovorni za prikupljanje, upotrebu, održavanje, dijeljenje podataka od strane trećih lica. Ako pružate informacije na stranicama trećih strana i koristite te web stranice, biće primenljiva pravila o privatnosti i pravila o uslovima korišćenja definisana na web stranicama tih trećih strana. Preporučujemo Vam da pročitate pravila o privatnosti web stranica koje posjećujete, prije nego što tamo ostavite ili pošaljete lične podatke.',
    'privacy-paragraf-7' => 'Klikom na neki od naših sponzorisanih oglasa na Google-u, Facebook-u ili Instagram-u, Vi prihvatate mogućnost da ti podaci o Vašoj posjeti na našoj platformi mogu biti obrađeni od strane navedenih društvenih mreža ukoliko posjedujete nalog na njima. Ako želite da eventualno izbjegnete takvu situaciju, možete da se odjavite sa Vaših korisničkih naloga sa ovih društvenih mreža, pa da tek onda klikom na link na posjetite našu platformu na nekoj od tih društvenih mreža.',
    'privacy-paragraf-8' => 'Korištenjem internet stranice :app_name ste saglasni sa načinom prikupljanja i obrade podataka opisanim u ovoj Izjavi te skladištenjem i pristupom kolačićima na vašem uređaju.',
    ...
    'cookies-title-2' => 'Šta su sesijski ili privremeni kolačići (sesije)?',
    'cookies-paragraf-3' => 'Sesijski ili privremeni kolačići (sesije) su kolačići koji se koriste tokom vašeg posjeta web stranici, a automatski se uklanjaju s vašeg računara kada zatvorite web browser. Pomoću njih web stranice pohranjuju privremene podatke (npr. najčešće su to stavke u korpi za kupovinu na webshopu, rezervaciju vozila, bukiranje termina i slično).',
    'cookies-title-3' => 'Šta su stalni kolačići na web stranici?',
    'cookies-paragraf-4' => 'Stalni kolačići ostaju spremljeni na vašem računaru i nakon zatvaranja web browsera. Pomoću njih web stranice pohranjuju podatke i najčešće je riječ o vašim postavkama kod korištenja stranice. Stalni kolačići će ostati na vašem računaru tako dugo dok ih ručno ne uklonite ili dok im ne istekne rok, a na uređaju mogu ostati danima, mjesecima, čak i godinama. Oni vam osiguravaju dosljedno i učinkovito iskustvo dok posjećujete našu web stranicu ili koristite naše usluge.',
    'cookies-title-4' => 'Šta su kolačići prve strane?',
    'cookies-paragraf-5' => 'Kolačići prve strane dolaze s web stranice koju gledate, a to su privremeni ili stalni. Pomoću nijh web stranice pohranjuju podatke kao što su ime i lozinka, s ciljem da se ne morate ponovo prijavljivati prilikom svakog posjeta.',
    'cookies-title-5' => 'Šta su kolačići treće strane?',
    'cookies-paragraf-6' => 'Kolačići treće strane pripadaju različitim domenama od onog prikazanog u adresnoj traci. Web stranice mogu sadržavati sadržaj iz drugih područja (kao što su reklamni baneri, linkovi ili video zapisi), što otvara mogućnost za praćenje korisničke istorije pregledavanja. Na našoj web stranici ćete možda pronaći određeni sadržaj koji potiče sa drugih sajtova (Google, Facebook, Youtube, Instagram itd.) prilikom čega ti drugi sajtovi mogu da kod nas postave određene kolačiće. Radi se o kolačićima koji nisu postavljeni od strane nas kao vlasnika platforme. Putem ovih kolačića, treća lica koja su ih postavila mogu da dobijaju informacije o Vašem ponašanju na našoj platfomi. Mogućnosti podešavanja privatnosti u većini modernih browsera omogućuju blokiranje kolačića treće strane.',
    'cookies-title-6' => 'Da li mogu blokirati ili onemogućiti kolačiće sa ove web stranice?',
    'cookies-paragraf-7' => 'Isključivanjem kolačića, Vi odlučujete hoćete li dopustiti njihovo pohranjivanje na vašem računaru. Postavke mogu se kontrolisati i mijenjati u vašem web browseru. Ako onemogućite kolačiće, nećete moći koristiti pojedine funkcionalnosti web stranice. Većina web browser-a (preglednika) je podešena da automatski prihvata kolačiće. Ako ne želite da naša platforma čuva kolačiće na Vašem uređaju, možete promijeniti podešavanja u browser-u tako da dobijete upozorenje pre nego što se snime određeni kolačići. Takođe, isto tako možete podesiti Vaš browser da odbija većinu naših kolačića ili samo određene kolačiće trećih lica. Dodatno, možete povući svoj pristanak na kolačiće, brišući kolačiće koji su već sačuvani.',
    ...
    //Rooms
    'rooms-meta-title' => 'Sobe Restoran Tradicija Banja Luka | Smještaj i Komfor',
    'rooms-meta-desc' => 'Smještaj u sklopu Restorana Tradicija u Banjaluci – moderno opremljene sobe, privatni parking i mirna lokacija. Idealno mjesto za odmor, poslovni boravak ili vikend u Banjaluci.',
    'rooms-meta-keywords' => 'sobe banja luka, smještaj banja luka, hotel, apartmani, noćenje, restoran sa smještajem, privatni parking, komforne sobe, luksuzan smještaj, banjaluka rooms, tradicija sobe',
