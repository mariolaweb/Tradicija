<div class="hidden md:flex md:flex-col">
    <div class="z-20 w-full h-10 p-1.5 bg-primary text-gray-50">
        <div class="flex items-center justify-between mx-auto tracking-tight max-w-7xl">
            ...
            <a href="tel:+38766156156" class="inline-flex items-center group" aria-label="Phone Restoran Tradicija">
                <svg class="mx-2 group-hover:text-black size-6" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 512 512" xml:space="preserve" fill-rule="evenodd"><g>
            ...
            <div class="flex items-center space-x-2 text-xs">
                ...
                <a href="https://www.facebook.com/profile.php?id=61578833284399" target="_blank" aria-label="Facebook Restoran Tradicija">
                    <svg class="text-white size-6 hover:text-black" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 176 176" style="enable-background:new 0 0 512 512" xml:space="preserve"><g><g data-name="Layer 2">
                ...
                <a href="https://www.instagram.com/tradicijabl/" target="_blank" aria-label="Instagram Restoran Tradicija">
                    <svg class="text-white size-6 hover:text-black" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve"><g>
