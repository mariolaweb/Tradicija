...
{{-- <div class="z-50 w-full h-12 bg-gradient-to-t from-neutral-950 to-black" --}}
    ...
    <div class="w-full" x-bind:class="{ 'top-0 fixed h-10 bg-black z-30': !atTop }">
        ...
        <div class="flex items-center justify-between w-full mx-auto max-w-7xl">
            ...
            {{-- <button class="inline-flex items-center pl-10 text-white md:z-20 md:transform md:transition md:duration-200"
