<footer class="relative flex flex-col items-center w-full text-white bg-primary">
    ...
    <div class="flex flex-col w-full pt-3 mx-auto md:flex-row md:justify-between md:items-center max-w-7xl">
        ...
        <div class="flex flex-col items-center order-1 w-full px-3 py-4 md:order-2 md:w-1/3 md:text-sm">
            ...
            <div class="flex pt-0 space-x-4">
                <a href="https://www.facebook.com/profile.php?id=61578833284399" target="_blank" aria-label="Facebook Restoran Tradicija">
                    <svg class="text-white size-10 md:size-8 hover:text-secondary" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 176 176" style="enable-background:new 0 0 512 512" xml:space="preserve"><g><g data-name="Layer 2">
                ...
                <a href="https://www.instagram.com/tradicijabl/" target="_blank" aria-label="Instagram Restoran Tradicija">
                    <svg class="text-white size-10 md:size-8 hover:text-secondary" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve"><g>
    ...
    {{-- Tekst u footeru --}}
    {{-- <div class="flex flex-col items-center mx-4 mt-8 text-center md:mt-0 max-w-7xl md:mx-auto md:w-5/6">
    ...
    <a href="#" aria-label="Back to top">
        <svg class="absolute z-10 p-2 text-white rounded-full bg-secondary bottom-6 size-12 right-1 md:right-4 xl:right-5 animate-bounce"
    ...
    <div class="container flex flex-col items-center justify-center px-2 mx-auto -mt-1 text-xs text-white md:px-5">
        ...
        {{-- <p class="inline-flex items-center justify-center">
            ...
            <a href=" https://mariolaweb.com" target="_blank">
                <span class="ml-1 text-primary hover:text-white">@mariolaWeb</span>
            </a>
            </span>
        </p> --}}
    ...
    <div class="flex flex-col items-center justify-center w-full pt-2 pb-2.5 text-xs bg-primary">
        <p class="inline-flex pb-0 text-center">Copyright <span class="">©</span>
            <?php echo date('Y'); ?> | <span class="px-1 font-bold">Restoran Tradicija</span> Banja Luka
        </p>
         <p class="inline-flex items-center justify-center">
            <span class="mr-1 text-red-300">&hearts;</span>Product by
            <a href=" https://mariolaweb.com" target="_blank">
                <span class="ml-1 text-white hover:text-secondary">@mariolaWeb</span>
            </a>
            </span>
        </p>
            {{-- <x-base.lang-switcher /> --}}
