            ...
            <div
                ...
                <form wire:submit='submitForm' action="" class="relative form lg:mx-6 lg:my-2">
                    ...
                    <div class="mt-3.5 block md:flex md:space-x-5">
                        <div class="relative mt-3.5 w-full md:w-1/2">
                            ...
                            <input type="text" wire:model="name"
                                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm italic focus:border-primary focus:ring-primary"
                        ...
                        <div class="relative mt-3.5 w-full md:w-1/2">
                            ...
                            <input type="number" wire:model="phone"
                                class="block w-full rounded-lg border border-gray-300 bg-white p-2.5 pl-10 text-sm italic focus:border-primary focus:ring-primary"
                    ...
                    <textarea id="message" rows="3" wire:model="message"
                        class="bg-gray-white mt-3.5 block w-full rounded-lg border border-gray-300 p-2.5 text-sm italic focus:border-primary focus:ring-primary"
                    ...
                    @if (Session::get('message'))
                        <div class="flex flex-col justify-center flex-auto mt-4" x-data="{ show: true }"
                            ...
                            x-transition:leave.opacity.duration.1500ms x-init="setTimeout(() => show = false, 3500)">
                            <div class="flex items-center justify-center mb-1 text-white">
    ...
    <div class="w-full lg:pt-20">
        <div class="w-full p-2 bg-white rounded-xl">
            <iframe class="mx-auto rounded-xl"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2832.3062241848934!2d15.000630742196439!3d44.77456201706038!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475e032d8f925107%3A0xb801a71c2dba93e2!2sTRADICIJA%20RESTORAN!5e0!3m2!1shr!2sba!4v1761557348073!5m2!1shr!2sba"
