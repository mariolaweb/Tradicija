...
<head>
    ...
    <title>Poruka iz kontakt forme</title>
    <!--[if (mso 16)]>
<style type="text/css">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <a target="_blank" href="https://tradicija.ba"
                                                                        ...
                                                                        <img src="https://tradicija.ba/images/base/tradicija-logo-mail.webp"
                                                                            alt="Restoran Tradicija"
                                                                            style="display:block;border:0;border-radius:5px;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            height="48" title="Restoran Tradicija">
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-m-txt-c"
                                                                    style="padding:0;Margin:0;font-size:0px">
                                                                    <h3 style="Margin:0;line-height:20px;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;font-size:18px;font-style:normal;font-weight:bold;color:#2D3142">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:15px">
                                                                        <strong>Poruka od:</strong> {{ ucwords($data->name) }} <br>
                                                                        <strong>E-mail adresa:</strong> {{ $data->email }} <br>
                                                                        <strong>Telefon:</strong> {{ $data->phone }} <br><br>
                                                                        <strong>Tekst poruke:</strong> {{ ucfirst($data->message) }} <br>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#efefef" class="es-content-body" align="center" cellpadding="0"
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="Margin:0;padding-top:10px;padding-bottom:25px;padding-left:40px;padding-right:40px">
                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr>
                                                    <td align="center" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:14px">
                                                                        *Poruka poslana putem kontakt forme web stranice "Restoran Tradicija".
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    <td align="center" valign="top"
                                                        style="padding:0;padding-top:16px;Margin:0;width:520px">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            role="presentation"
                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <a target="_blank" href="https://tradicija.ba"
                                                                        ...
                                                                        <img src="https://tradicija.ba/images/base/tradicija-logo-mail.webp"
                                                                            alt="Restoran Tradicija"
                                                                            style="display:block;border:0;border-radius:5px;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            height="28" title="Sheriff Grill Pub">
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#bcb8b1" class="es-footer-body" align="center" cellpadding="0"
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="Margin:0;padding-left:20px;padding-right:20px;padding-bottom:30px;padding-top:10px">
                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr>
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <a target="_blank" href="https://tradicija.ba"
                                                                            ...
                                                                            Copyright © Restoran Tradicija<a target="_blank"
                                                                            href=""
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#2D3142;font-size:14px"></a>
                                                                    </p>
                                                                </td>
